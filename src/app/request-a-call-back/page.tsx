...
export default function RequestCallBackPage() {
  ...
  return (
    <>
      ...
      <section className="bg-surface pt-40 pb-24">
        <div className="max-w-screen-2xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="mt-16 hidden lg:block">
              <div className="flex gap-16">
                <div>
                  ...
                  <p className="label-upper text-on-surface-variant/40 mt-2">Years</p>
                </div>
                <div>
                  <span className="font-serif text-3xl text-gold">500+</span>
                  <p className="label-upper text-on-surface-variant/40 mt-2">Families Served</p>
                </div>
              </div>
              <p className="text-on-surface-variant/50 text-sm mt-8 max-w-sm leading-relaxed">
                Owner-operated since 1994. Same cleaner every visit.
              </p>
            </div>
          </div>

          {/* Right — form */}
          <div className="bg-surface-low p-8 sm:p-12 rounded-sm">
